...
TEST(TestTotalsAndSigns, TotalPriceWithMissing2) {
  ExpectParse(R"(
    2013-05-18 * ""
      Assets:Investments:MSFT            MSFT @@ 2000.00 USD
      Assets:Investments:Cash   20000.00 USD
...
TEST(TestMetaData, MetadataTransactionRepeated2) {
  ExpectParse(R"(
    2013-05-18 * ""
      test: "Bananas"
      test: "Apples"
...
TEST(TestExpressions, ExplicitPrecision2) {
  ExpectParse(R"(
    2021-09-19 balance Assets:US:Checking   (1 + 5) / 2.1 USD
