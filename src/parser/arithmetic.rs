// adapted from https://github.com/rust-bakery/nom/blob/main/tests/arithmetic.rs, with thanks 😊
// replaced fold with fold_many0, without the initial range parameter
